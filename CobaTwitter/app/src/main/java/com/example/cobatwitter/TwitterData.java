...
public class TwitterData {
    ...
    public static ArrayList<UserTwitter> getListData(){
        UserTwitter userTwitter = null;
        ArrayList<UserTwitter> list = new ArrayList<>();
        for (String[] aData : data) {
            userTwitter = new UserTwitter();
            userTwitter.setUserName(aData[0]);
            userTwitter.setTweet(aData[1]);
            userTwitter.setPhoto(aData[2]);

            list.add(userTwitter);
        }
